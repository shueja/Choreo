...
export function commandIsNamed(command: PplibCommand | undefined): command is NamedCommand {
...
export function commandIsGroup(command: PplibCommand | undefined): command is GroupCommand {
  return command !== undefined && commandTypeIsGroup(command.type);
}
export function commandIsWait(command: PplibCommand | undefined): command is WaitCommand {
...
export const CommandStore = types
  ...
  .views((self) => ({
    get serialize(): PplibCommand | undefined {
      if (self.isNone) {
        return undefined;
      }
      if (self.isNamed) {
  ...
  .actions((self) => ({
    deserialize(ser: PplibCommand | undefined) {
