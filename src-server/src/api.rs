...
async fn guess_control_interval_counts(json: web::Json<GuessControlIntervalCountsBody>) -> ChoreoResponse<Vec<usize>> {
    result_to_response(choreo_core::generation::intervals::guess_control_interval_counts(
