...
import {
  IWaypointStore} from "@choreo/stores/WaypointStore";
import {
  EXPR_DEFAULTS} from "@choreo/stores/RobotConfigStore";
import { ViewLayerDefaults } from "./UIData";
import { UIStateStore } from "./UIStateStore";
import { findUUIDIndex } from "@choreo/stores/path/utils";
import { ChoreoError, OpenFilePayload, ServerCommands, TauriCommands } from "./tauriCommands";
import { tracing } from "./tauriTracing";
import { Env, getConstructors, SelectableItemTypes } from "./Env";
...
//         (doc.selectedSidebarItem as IWaypointStore).copyToClipboard(e);
//       }
//       e.preventDefault();
//     }
//   });
...
//             (doc.selectedSidebarItem as IWaypointStore).uuid,
...
//     const selected = waypoints.find((w:IWaypointStore) => {
//       return w.selected;
//     });
