...
export const VSCodeExpressionInput = observer(
  (props: VSCodeExpressionInputProps) => {
    ...
    const validate = (expression: string): MathNode | undefined => {
      try {
        return props.expr.validate(math.parse(expression));
      } catch (e) {
        return undefined;
      }
    };
    ...
    useEffect(
      () => autorun(() => setEditedValue(props.expr.expr.toString())),
      []
    );
    ...
    <>
      ...
      >
        <vscode-table-body slot="body">
          ...
          <RobotConfigRow
            title="MoI"
            expr={robotConfig.inertia}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Bumper Front"
            expr={robotConfig.bumper.front}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Bumper Back"
            expr={robotConfig.bumper.back}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Bumper Side"
            expr={robotConfig.bumper.side}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Wheel Radius"
            expr={robotConfig.radius}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Wheel COF"
            expr={robotConfig.cof}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Motor Rev/Wheel Rev"
            expr={robotConfig.gearing}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Motor Max Speed"
            expr={robotConfig.vmax}
          ></RobotConfigRow>
          <RobotConfigRow
            title="Motor Max Torque"
            expr={robotConfig.tmax}
          ></RobotConfigRow>
          <vscode-table-row>
            ...
            <vscode-table-cell>
              <vscode-single-select>
                ...
                <vscode-option description="Donec elit odio">
                  Differential
                </vscode-option>
              </vscode-single-select>
            </vscode-table-cell>
