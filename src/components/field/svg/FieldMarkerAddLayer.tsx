...
import FieldConstraintRangeLayer from "./constraintDisplay/FieldConstraintRangeLayer";
...
class FieldConstraintsAddLayer extends Component<Props, State> {
  ...
  add(
    ...
    doc.history.startGroup(() => {
      ...
      const newMarker = doc.pathlist.activePath.addEventMarker(

      );
      if (newMarker !== undefined) {
        newMarker.from.setTarget({ uuid: point1.uuid });
        newMarker.to.setTarget(point2 !== undefined ? { uuid: point2.uuid } : undefined);
