...
import { NavbarItemData } from "../ui/NavbarData";
...
function PathAnimationSlider(props: Props) {
    const activePath = props.path;
    const totalTime = activePath.trajectory.getTotalTimeSeconds();
    return (
      <>
        <Slider
          defaultValue={0}
